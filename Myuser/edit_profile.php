...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "edit_data")) {
  $updateSQL = sprintf("UPDATE user SET ID_user=%s, Username=%s, Email=%s, Password=%s, Phone1=%s, Phone2=%s, Line=%s, FB=%s, Address=%s, permission=$permission WHERE ID=%s",
                       ...
                       GetSQLValueString($row_Myuser['Password'], "text"),
                        ...
                        <div class="panel-body">
                            <form action="<?php echo $editFormAction; ?>" name="edit_data" id="edit_data" method="POST" class="form-horizontal">
                            	<div id="panel" class="col-md-12">	
                                    <div id="lable" class="col-md-3"><span id="track">#&nbsp;</span>ชื่อผู้ใช้</div>
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" id="username" name="username" placeholder="username" value="<?php echo $row_Myuser['Username']; ?>"/>
                                    </div>
                                </div>
                                <div id="panel" class="col-md-12">	
                                    <div id="lable" class="col-md-3"><span id="track">#&nbsp;</span>เบอร์โทรติดต่อ</div>
                                    <div class="col-md-6">
                                        <input type="number" class="form-control" id="phone_1" name="phone_1" placeholder="Telephone" value="<?php echo $row_Myuser['Phone1']; ?>"/>
                                    </div>
                                </div>
                                <div id="panel" class="col-md-12" style=" padding-top:8px;">	
                                    <div id="lable" class="col-md-3"></div>
                                    <div class="col-md-6">
                                        <input type="number" class="form-control" id="phone_2" name="phone_2" placeholder="Telephone" value="<?php echo $row_Myuser['Phone2']; ?>"/>
                                    </div>
                                </div>
                                <div id="panel" class="col-md-12">	
                                ...
                                <div id="panel" class="col-md-12">	
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="address" rows="5" maxlength="500" class="form-control" id="address" placeholder="Address" style="max-width: 400px; resize: none" ><?php echo $row_Myuser['Address']; ?></textarea>
                                    </div>
                                </div>
                                
                                <div id="panel" class="col-md-12" style="padding: 3px 30px;">
                                	<div class="bar_Dash1"></div>
                                    <div id="lable" class="col-md-3"></div>
                                    <div class="col-md-4">
                                        <input type="password" class="form-control" id="pass_con" name="pass_con" placeholder="กรอกรหัสของคุณเพื่อยืนยัน" />
                                    </div>
                                </div>
                                <div id="panel" class="col-md-12">	
                                    <div id="lable" class="col-md-3"></div>
                                ...
                                <input id="id_user" name="id_user" type="hidden" value="<?php echo $row_Myuser['ID_user']; ?>">
                                <input id="email" name="email" type="hidden" value="<?php echo $row_Myuser['Email']; ?>">
...
<nav class="navbar-fixed-bottom ">
 ...
 <input id="P" name="P" type="hidden" value="<?php echo $row_Myuser['Password']; ?>">

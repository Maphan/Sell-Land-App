...
CREATE TABLE `post` (
  ...
  `area_size_rai` int(6) DEFAULT NULL,
  `area_size_ngan` int(4) DEFAULT NULL,
  `area_size_var` float DEFAULT NULL,
  `Price` int(10) DEFAULT NULL,
  `Geography` varchar(50) NOT NULL,
  `Pravince` varchar(100) NOT NULL,
...
--
-- Table structure for table `visit_post`
--

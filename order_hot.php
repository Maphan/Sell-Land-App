...
$query_Hot_order = "SELECT * FROM post,visit_post,province WHERE visit_post.id_post=post.ID_post AND post.Pravince=province.PROVINCE_ID ORDER BY visit_post.visit DESC";
...
<?php $i=0; do { $i++;?>
  <div class="col-md-12" style=" padding: 10px 10px; border-bottom: 1px solid #D5D5D5;">
    <a href="view_order.php?id_order=<?php echo $row_Hot_order['ID_post']; ?>">
     ...
     <div class="col-md-7" style="padding-right:0px;">
      ...
      <span class="text-W3 text-size-15 font"> <span class="text-danger text-size-18"><?php echo number_format($row_Hot_order['Price']); ?></span> บาท</span>
    </div>
  ...
  <?php } while ($row_Hot_order = mysql_fetch_assoc($Hot_order)); ?>
<?php
